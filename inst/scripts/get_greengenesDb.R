### =========================================================================
### Downloading database greengenes 13_8 97 OTU database
...
getGreenGenes13.8.97Db <- function(
        db_name = "gg_13_8_OTU97",
        seq_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/rep_set/97_otus.fasta",
        taxa_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/taxonomy/97_otu_taxonomy.txt",
        tree_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/trees/97_otus.tree"
){
